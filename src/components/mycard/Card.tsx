...
export default function CardView({ card, onToggleMainCard }: CardProps) {
  const { id, image, name, company, isMainCard } = card;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start gap-[10px] flex-1 min-w-0 h-[131px] pr-[30px]">
        {/* Card Name */}
        <div
          className="w-full h-[19px] font-medium text-[16px] leading-[19px] text-black flex-none mb-2"
        ...
        {/* Tags Container */}
        {/* {benefit && benefit[0] && benefit.length > 0 && (
